...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
  output_filename = 'mouth_%s_%05d-of-%05d.tfrecord' % (
...
def run(dataset_dir, output_dir):
  ...
  print('\nFinished converting the Mouth dataset!')

if __name__ == '__main__':
  if len(sys.argv) != 3:
    print ("python conver_mouth.py input_dir output_dir {}".format(len(sys.argv)))
  else:
